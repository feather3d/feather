...
/*-----------------------------------------------
              @(target):= _pyvulture.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__pyvulture

#else
#  define SWIG_init    init_pyvulture

#endif
#define SWIG_name    "_pyvulture"
...
SWIGINTERN PyObject *_wrap_new_Window(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  feather::vulkan::Window *result = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)":new_Window")) SWIG_fail;
  result = (feather::vulkan::Window *)new feather::vulkan::Window();
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_feather__vulkan__Window, SWIG_POINTER_NEW |  0 );
  return resultobj;
fail:
  return NULL;
}
...
SWIGINTERN PyObject *_wrap_delete_Window(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  feather::vulkan::Window *arg1 = (feather::vulkan::Window *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  PyObject * obj0 = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)"O:delete_Window",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_feather__vulkan__Window, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_Window" "', argument " "1"" of type '" "feather::vulkan::Window *""'"); 
  }
  arg1 = reinterpret_cast< feather::vulkan::Window * >(argp1);
  delete arg1;
...
SWIGINTERN PyObject *Window_swigregister(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  SWIG_TypeNewClientData(SWIGTYPE_p_feather__vulkan__Window, SWIG_NewClientData(obj));
  return SWIG_Py_Void();
}
